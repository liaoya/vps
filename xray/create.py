...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--operation", choices=("clean", "restart", "start", "stop"), required=True, help="")
    parser.add_argument("-p", "--protocol", choices=("shadowsocks", "vmess"), required=True, help="")
    parser.add_argument("-s", "--stream", choices=("kcp",), help="")
